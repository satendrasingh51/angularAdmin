import { Component, ChangeDetectionStrategy, ViewChild, AfterViewInit, Output, EventEmitter ,OnInit} from '@angular/core';
...
export class ImageCropperComponent implements AfterViewInit,OnInit {
  imagevalue;
  @Output('getprofileimage') sendprofileimage = new EventEmitter<any>();
  ...
  ngOnInit(){
    this.imagevalue = localStorage.getItem('profileImage');
  }
  ngAfterViewInit() {
    ...
    if (Platform.isBrowser) {
      ...
      //alert(sessionStorage.getItem('profileImage')),
  ...
  onCropped(e: ImgCropperEvent) {
    ...
    this.sendprofileimage.emit(this.croppedImage);
  }
